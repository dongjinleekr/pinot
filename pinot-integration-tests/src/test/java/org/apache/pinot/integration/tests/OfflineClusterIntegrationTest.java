...
public class OfflineClusterIntegrationTest extends BaseClusterIntegrationTestSet {
  ...
  public void testInvertedIndexTriggering()
    ...
    TestUtils.waitForCondition(aVoid -> {
      try {
        ...
        System.out.println("Response: " + queryResponse.toString());
  ...
  public void testStarTreeTriggering()
    ...
    // Otherwise there is no way to tell whether the reload on server side is finished.
    // 10 seconds are still better than hitting race condition which will timeout after 10 minutes.
